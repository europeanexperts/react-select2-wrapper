...
var Select2 = function (_Component) {
  ...
  _createClass(Select2, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!(0, _shallowEqualFuzzy2.default)(prevProps.value, this.props.value) || !(0, _shallowEqualFuzzy2.default)(this.el.val(), this.props.value)) {
    ...
    value: function setValue(value) {
      ...
      console.log('Current: ' + elVal + ' || New: ' + value + ' || Is equal: ' + (elVal == value) + ' || is fuzzy equal ? ' + (0, _shallowEqualFuzzy2.default)(elVal, value));
